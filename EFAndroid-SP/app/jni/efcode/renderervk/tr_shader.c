...
/*
====================
RE_RegisterShader3D  (EF: register a shader with no lightmap, for 3D-model UI/HUD)
====================
*/
qhandle_t RE_RegisterShader3D( const char *name ) {
	...
	sh = R_FindShader( name, LIGHTMAP_NONE, qfalse );   // EF (HM 2cdcf5e): 3D-model UI/HUD shaders un-mipped (not picmip-blurred)

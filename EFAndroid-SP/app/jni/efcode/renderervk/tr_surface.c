...
static void RB_SurfaceSprite( void ) {
	...
	if ( backEnd.currentEntity->e.data.sprite.rotation == 0.0 ) {
		...
		ang = M_PI * backEnd.currentEntity->e.data.sprite.rotation / 180.0;
		s = sin( ang );
		c = cos( ang );
	...
	RB_AddQuadStamp( backEnd.currentEntity->e.origin, left, up, *(color4ub_t *)backEnd.currentEntity->e.shaderRGBA );
}
...
static void RB_SurfacePolychain( const srfPoly_t *p ) {
	...
	for ( i = 0; i < p->numVerts; i++ ) {
		...
		tess.vertexColors[numv] = *(color4ub_t *)p->verts[ i ].modulate;
...
static void DoRailCore( const vec3_t start, const vec3_t end, const vec3_t up, float len, float spanWidth )
{
	...
	tess.vertexColors[tess.numVertexes].rgba[0] = backEnd.currentEntity->e.shaderRGBA[0] * 0.25;
	tess.vertexColors[tess.numVertexes].rgba[1] = backEnd.currentEntity->e.shaderRGBA[1] * 0.25;
	tess.vertexColors[tess.numVertexes].rgba[2] = backEnd.currentEntity->e.shaderRGBA[2] * 0.25;
	tess.numVertexes++;

	VectorMA( start, spanWidth2, up, tess.xyz[tess.numVertexes] );
	tess.texCoords[0][tess.numVertexes][0] = 0;
	tess.texCoords[0][tess.numVertexes][1] = 1;
	tess.vertexColors[tess.numVertexes].rgba[0] = backEnd.currentEntity->e.shaderRGBA[0];
	tess.vertexColors[tess.numVertexes].rgba[1] = backEnd.currentEntity->e.shaderRGBA[1];
	tess.vertexColors[tess.numVertexes].rgba[2] = backEnd.currentEntity->e.shaderRGBA[2];
	tess.numVertexes++;
...
static void RB_SurfaceOrientedSprite( void )
{
	...
	RB_AddQuadStamp( ent->e.origin, left, up, *(color4ub_t *)ent->e.shaderRGBA );
}
	     ...
	     vec3_t *corners, float starttex, float endtex, refEntity_t *e)
{
	...
	// Texture stuff....
	tess.texCoords[0][ndx][0] = 0;
	tess.texCoords[0][ndx][1] = starttex;

	tess.texCoords[0][ndx+1][0] = 1;
	tess.texCoords[0][ndx+1][1] = starttex;
	
	tess.texCoords[0][ndx+2][0] = 1;
	tess.texCoords[0][ndx+2][1] = endtex;

	tess.texCoords[0][ndx+3][0] = 0;
	tess.texCoords[0][ndx+3][1] = endtex;

	tess.vertexColors[ndx].rgba[0] = tess.vertexColors[ndx+1].rgba[0] = tess.vertexColors[ndx+2].rgba[0] = tess.vertexColors[ndx+3].rgba[0] = e->shaderRGBA[0];
	tess.vertexColors[ndx].rgba[1] = tess.vertexColors[ndx+1].rgba[1] = tess.vertexColors[ndx+2].rgba[1] = tess.vertexColors[ndx+3].rgba[1] = e->shaderRGBA[1];
	tess.vertexColors[ndx].rgba[2] = tess.vertexColors[ndx+1].rgba[2] = tess.vertexColors[ndx+2].rgba[2] = tess.vertexColors[ndx+3].rgba[2] = e->shaderRGBA[2];
...
void RB_SurfaceLine2( void )
{
	...
	// Texture stuff....
	tess.texCoords[0][ndx][0] = 0;
	tess.texCoords[0][ndx][1] = 0;

	tess.texCoords[0][ndx+1][0] = 0.5;
	tess.texCoords[0][ndx+1][1] = 0;
	
	tess.texCoords[0][ndx+2][0] = 1;
	tess.texCoords[0][ndx+2][1] = 0;

	tess.texCoords[0][ndx+3][0] = 1;
	tess.texCoords[0][ndx+3][1] = 1;

	tess.texCoords[0][ndx+4][0] = 0.5;
	tess.texCoords[0][ndx+4][1] = 1;

	tess.texCoords[0][ndx+5][0] = 0;
	tess.texCoords[0][ndx+5][1] = 1;

	tess.vertexColors[ndx].rgba[0] = tess.vertexColors[ndx+1].rgba[0] = tess.vertexColors[ndx+2].rgba[0] =
		tess.vertexColors[ndx+3].rgba[0] = tess.vertexColors[ndx+4].rgba[0] = tess.vertexColors[ndx+5].rgba[0] = e->shaderRGBA[0];
	tess.vertexColors[ndx].rgba[1] = tess.vertexColors[ndx+1].rgba[1] = tess.vertexColors[ndx+2].rgba[1] =
		tess.vertexColors[ndx+3].rgba[1] = tess.vertexColors[ndx+4].rgba[1] = tess.vertexColors[ndx+5].rgba[1] = e->shaderRGBA[1];
	tess.vertexColors[ndx].rgba[2] = tess.vertexColors[ndx+1].rgba[2] = tess.vertexColors[ndx+2].rgba[2] =
		tess.vertexColors[ndx+3].rgba[2] = tess.vertexColors[ndx+4].rgba[2] = tess.vertexColors[ndx+5].rgba[2] = e->shaderRGBA[2];
	tess.vertexColors[ndx].rgba[3] = tess.vertexColors[ndx+1].rgba[3] = tess.vertexColors[ndx+2].rgba[3] =
...
void RB_SurfaceCylinder(void)
{
	...
	while(index < planes)
	{
		...
		if(e->data.cylinder.wrap)
		{
			tess.texCoords[0][ndx][0] = tcstep * (index - 1);
			tess.texCoords[0][ndx][1] = 0;
			
			tess.texCoords[0][ndx+1][0] = tcstep * (index - 1);
			tess.texCoords[0][ndx+1][1] = 1;

			tess.texCoords[0][ndx+2][0] = tcstep * index;
			tess.texCoords[0][ndx+2][1] = 0;
			
			tess.texCoords[0][ndx+3][0] = tcstep * index;
			tess.texCoords[0][ndx+3][1] = 1;
		}
		else
		{
			...
			tess.texCoords[0][ndx+1][0] = 0;
			tess.texCoords[0][ndx+1][1] = 1;

			tess.texCoords[0][ndx+2][0] = e->data.cylinder.stscale;
			tess.texCoords[0][ndx+2][1] = 0;
			
			tess.texCoords[0][ndx+3][0] = e->data.cylinder.stscale;
			tess.texCoords[0][ndx+3][1] = 1;
		}
		...
		tess.vertexColors[ndx].rgba[1] = tess.vertexColors[ndx+1].rgba[1] = tess.vertexColors[ndx+2].rgba[1] = tess.vertexColors[ndx+3].rgba[1] = e->shaderRGBA[1];
		tess.vertexColors[ndx].rgba[2] = tess.vertexColors[ndx+1].rgba[2] = tess.vertexColors[ndx+2].rgba[2] = tess.vertexColors[ndx+3].rgba[2] = e->shaderRGBA[2];
		tess.vertexColors[ndx].rgba[3] = tess.vertexColors[ndx+1].rgba[3] = tess.vertexColors[ndx+2].rgba[3] = tess.vertexColors[ndx+3].rgba[3] = 255;

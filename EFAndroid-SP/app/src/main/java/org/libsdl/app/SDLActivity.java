...
class DummyEdit extends View implements View.OnKeyListener {
    ...
    public DummyEdit(Context context) {
        ...
        // EFSP: kill the green border on the save-name text field. The DummyEdit is a real,
        // focusable View sized to the field rect; on Android 8.0 (API 26)+ every View draws the
        // accent-colored default focus highlight when focused (renders as a green ring/box over
        // the field). It is purely cosmetic — IME capture works without it — so disable it.
        // Also clear any background so the view contributes nothing visible.
        if (Build.VERSION.SDK_INT >= 26 /* Android 8.0 (O) */) {

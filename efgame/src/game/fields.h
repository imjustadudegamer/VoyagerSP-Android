...
#ifndef FOFS
#define	FOFS(x) ((int)(intptr_t)&(((gentity_t *)0)->x))	// usually already defined in qshared.h
#endif
#define	STOFS(x) ((int)(intptr_t)&(((spawn_temp_t *)0)->x))	// (intptr_t) cast = LP64-safe (arm64); offset still fits int
#define	LLOFS(x) ((int)(intptr_t)&(((level_locals_t *)0)->x))
#define	CLOFS(x) ((int)(intptr_t)&(((gclient_t *)0)->x))
#define NPCOFS(x) ((int)(intptr_t)&(((gNPC_t *)0)->x))
//
...
//	F_OSD,				// ObjectSpawnData object handling
	...
	F_BOOLPTR,			// Generic pointer that is recreated later, could be left alone, but clearer if only 0/1 rather than 0/malloc		

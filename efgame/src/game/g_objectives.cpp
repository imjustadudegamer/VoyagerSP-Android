...
void OBJ_ParseObjectives(char *buffer)
{
	...
	for ( int k = 0; k < MAX_OBJECTIVES; k++ )
		mission_objective_text[k] = (char *)defstr;
	for ( int k = 0; k < MAX_TOUR_OBJECTIVES; k++ )
		tour_objective_text[k] = (char *)defstr;
...
void OBJ_ParseTactical(char *buffer)
{
	...
	for ( int k = 0; k < MAX_TACTICAL_TXT; k++ )
		tactical_text[k] = (char *)defstr;

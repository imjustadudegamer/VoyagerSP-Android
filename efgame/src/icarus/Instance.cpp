...
int ICARUS_Instance::LoadSequencers( void )
{
	...
	m_interface->I_ReadSaveData( '#SQR', &numSequencers, sizeof( numSequencers ), NULL );	// was sizeof(&numSequencers): 8B on LP64 vs the 4B written (benign via stored-length reader, but wrong)
